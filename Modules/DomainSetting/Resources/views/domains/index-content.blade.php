        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            ...
            <div class="kt-portlet kt-portlet--mobile">
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{__('domainsetting::domains.domains')}}</span>
                            <small>{{__('domainsetting::domains.list')}}</small>
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            ...
                            <a href="{{route('domains.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
                                <i class="flaticon2-plus"></i> {{trans('Domain::domains.create_new')}}
                            </a>
                            --}}
                            @if (auth()->user()->hasPermission('create-domains'))
                                <a href="{{route('domains.create')}}" class="btn btn-primary btn-sm"  data-path="{{route('domains.modals.create')}}" data-title="{{__('domainsetting::domains.create_domains')}}" data-modal-load>
                                    <span>
                                        <i class="la la-plus"></i>
                                        <span>{{__('domainsetting::domains.create_domains')}}</span>
                                    </span>
                                </a>
                            @endif
                            {{--
                ...
                <div class="kt-portlet__body">
                    ...
                    <!--begin: Datatable -->
                    <table class="table table-striped- table-bordered table-hover table-checkable datatable" id="domain_table">
                        <thead>
                            <tr>
                                <th>{{__('domainsetting::domains.id')}}</th>
                                <th>{{__('domainsetting::domains.domains')}}</th>
                                                                <th>{{__('domainsetting::domains.folder_name')}}</th>

                                <th>{{__('domainsetting::domains.page')}}</th>
                                <th>{{__('domainsetting::domains.created_at')}}</th>
                                <th>{{__('domainsetting::domains.last_updated_at')}}</th>
                                <th>{{__('domainsetting::domains.actions')}}</th>
                            </tr>
                        </thead>
                    </table>
                    <!--end: Datatable -->
