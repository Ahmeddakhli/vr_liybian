...
class ISellUnitRequest extends Model implements HasMedia
{
    use SoftDeletes, SoftCascadeTrait, HasMediaTrait;
    ...
    protected $table = 'i_sell_unit_requests';
     ...
     */
    protected $fillable = [
        'id', 'compound', 'i_purpose_id', 'i_purpose_type_id', 'unit_name', 'comments', 'name', 'email', 'phone','pay_status' , 'i_unit_id','is_seen','user_id', 'created_at', 'updated_at'
    ];
    ...
    public function unit(){
        return $this->belongsTo(IUnit::class, 'i_unit_id', 'id');
    }
