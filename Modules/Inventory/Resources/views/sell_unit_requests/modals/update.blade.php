...
@section('content')
<!--begin::Form-->
<form action="{{route('inventory.sell_unit_requests.update')}}" method="POST" id="update_sell_request_form" class="m-form m-form--fit m-form--label-align-right m-form--group-seperator" data-async data-callback="UpdateISellRequestCallback" data-parsley-validate>
    @csrf
