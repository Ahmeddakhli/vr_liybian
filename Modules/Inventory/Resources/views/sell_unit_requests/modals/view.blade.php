<table class="table">
    <thead class="thead-dark">
        <tr>
            ...
            <th scope="col">{{__('inventory::inventory.pay_status')}}</th>
            <th scope="col">{{__('inventory::inventory.service')}}</th>
    ...
    <tbody>
        <tr>
            ...
            <td>{{$i_sell_request->pay_status}}</td>
            <td>{{$i_sell_request->service}}</td>
