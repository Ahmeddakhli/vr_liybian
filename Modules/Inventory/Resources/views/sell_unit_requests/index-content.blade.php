                ...
                <div class="kt-portlet__head kt-portlet__head--lg">
                    <div class="kt-portlet__head-label">
                        ...
                        <h3 class="kt-portlet__head-title">
                            <span data-8xloadtitle>{{trans('inventory::inventory.sell_unit_requests')}}</span>
                    ...
                    <div class="kt-portlet__head-toolbar">
                        <div class="kt-portlet__head-wrapper">
                            {{--
                            <!-- Full creation form -->
                            <a href="{{route('inventory.sell_unit_requests.create')}}" data-8xload class="btn btn-brand btn-icon-sm">
                                <i class="flaticon2-plus"></i> {{trans('inventory::inventory.create_new')}}
                            </a>
                            --}}
                            {{--
                            @haspermission('create-inventory-sell-request')
                                <a href="{{route('inventory.sell_unit_requests.create')}}" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#fast_modal" data-path="{{route('inventory.sell_unit_requests.modals.create')}}" data-title="{{trans('inventory::inventory.create_sell_request')}}" data-modal-load>
                                    <span>
