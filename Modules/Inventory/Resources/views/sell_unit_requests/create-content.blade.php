    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <a href="{{route('inventory.sell_unit_requests.index')}}" data-8xload class="kt-subheader__breadcrumbs-link">{{trans('inventory::inventory.sell_unit_requests')}}</a>
                <span class="kt-subheader__breadcrumbs-separator"></span>
            ...
            <div class="col-lg-12">
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile">
                    ...
                    <div class="kt-portlet__body">
                        <!-- Create LCC Form -->
                        <form action="{{route('inventory.sell_unit_requests.store')}}" data-async data-reset="true" data-set-autofocus method="POST" id="create_sell_request_form" class="kt-form" data-parsley-validate>
                            @csrf
                            <div class="row">
