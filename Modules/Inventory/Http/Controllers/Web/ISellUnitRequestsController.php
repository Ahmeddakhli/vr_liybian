...
use Modules\Inventory\Http\Requests\SellUnitRequests\CreateISellRequestRequest;
use Modules\Inventory\Http\Requests\SellUnitRequests\UpdateISellRequestRequest;
use Modules\Inventory\Http\Requests\SellUnitRequests\DeleteISellRequestRequest;
use Modules\Inventory\Http\Controllers\Actions\SellUnitRequests\CreateISellRequestAction;
use Modules\Inventory\Http\Controllers\Actions\SellUnitRequests\UpdateISellRequestAction;
use Modules\Inventory\Http\Controllers\Actions\SellUnitRequests\DeleteISellRequestAction;
use Modules\Inventory\Http\Controllers\Actions\SellUnitRequests\GetISellRequestByIdAction;
use Modules\Inventory\Http\Controllers\Actions\SellUnitRequests\SearchISellRequestsQueryAction;
use Modules\Inventory\ISellUnitRequest;
use Modules\Inventory\Http\Controllers\Actions\Purposes\GetIPurposesAction;

class ISellUnitRequestsController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            return view('inventory::sell_unit_requests.' . $blade_name, []);
        }
    }
    ...
    public function show($id)
    {
        ...
        ISellUnitRequest::find($id)->update([
            'is_seen' => 1
        ]);

        return view('inventory::sell_unit_requests.modals.view',compact('i_sell_request'))->render();
    }
    ...
    public function createISellRequestModal(Request $request)
    {
        ...
        return view('inventory::sell_unit_requests.modals.create',compact('purposes'),[])->render();
    }
    ...
    public function UpdateISellRequestModal(Request $request, $id = null)
    {
        ...
        return view('inventory::sell_unit_requests.modals.update', compact('i_sell_request', 'attachments','purposes'), [])->render();
    }
}
