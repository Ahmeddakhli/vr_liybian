<header class="main-header">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container mx-0">
            ...
            <a class="navbar-brand p-0 m-0" href="{{ route('front.home') }}" style="width: 90px;">
                <img class="dark-logo" src="{{ asset('front/assets/logo/logo.png') }}" alt=""
                    style="width: 80px;height: 80px;">
                <img class="white-logo" src="{{ asset('front/assets/logo/logo.png') }}" alt=""
                    style="width: 80px;height: 80px;">

            </a>
            <a class="nav-link" href="{{ route('front.home') }}">المكعب </a>
            <form class="d-flex input-group w-auto" action=" {{ isset($url) ? $url : route('front.properties') }}">
                <input type="search" class="form-control rounded" placeholder="Search" aria-label="Search"
                    name="q" />
                <span class="input-group-text text-white border-0" style="background-color: blue">
                    <i class="fas fa-search" onclick="this.parentElement.parentElement.submit()"></i>
                </span>
            </form>
            ...
            <div class="collapse navbar-collapse" id="main-menu">
                <ul class="navbar-nav align-items-lg-center ms-auto my-lg-0 my-3 mb-lg-0 mx-auto">
                    <li class="nav-item active mx-3">
                        <a class="nav-link" href="{{ route('front.home2') }}">{{ __('main.home_title') }}</a>
                    </li>
                ...
                <ul class="dropdown-menu">
                  ...
                  @endforeach
                    ...
                    <!--<li class="nav-item dropdown">-->
                    <!--    <a class="site-btn sell-btn" href="{{ route('front.login') }}">-->
                    <!--        تسجيل </a>-->
                    ...
                    <li class="nav-item change-mode">
                        <button class="theme-toggle" id="theme-toggle" title="Toggles light &amp; dark">
                            <svg width="24" height="24" viewBox="0 0 24 24">
                                ...
                                <circle class="sun" cx="12" cy="12" r="11" mask="url(#moon)">
                                </circle>
                                <g class="sun-beams">
